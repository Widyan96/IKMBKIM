            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            <p><center><h1>Hapus Data</h1>

                                <h2>Anda Yakin Menghapus Data Dibawah Ini?</h2>

                                 <?php 
                                    $id = $_GET['id'];
                                    $no_urut = 0;
                                    $data1 = mysqli_query($config,"select * from survey where id=$id");
                                    while($d1 = mysqli_fetch_array($data1)){
                                    $no_urut++;
                                ?>
                                <h2>
                                <table class="table"> <tr>
                                    <td style="width: 5%;"><center><?php echo $no_urut ?></center></td>
                                    <td style="width: 55%;"><center><?php echo $d1['survey'] ;?></center></td>
                                    <td style="width: 45%;"><center><?php echo $d1['waktu'] ;?></center></td>
                             ...
                             <center><a href="hapus_data.php?id=<?php echo $d1['id'];?>" class="btn btn-danger waves-effect waves-light text-white">Hapus</a></center>
                             <?php } ?>
                        </div>
                    </div>
                </div>
